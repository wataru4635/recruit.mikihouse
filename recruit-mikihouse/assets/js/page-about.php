...
<main>
      ...
      <ul class="about-nav__list">
        ...
        <li class="about-nav__item">
          <a href="#global-expansion" class="about-nav__link"><span class="about-nav__link-arrow"></span><span
              class="about-nav__link-text">世界16地域108店舗へ</span></a>
        </li>
        <li class="about-nav__item">
      ...
      <div class="craftsmanship__safety">
        ...
        <div class="craftsmanship__card-list">
          ...
          <div class="craftsmanship__card craftsmanship__card--02 js-fade-up --delay-2">
            ...
            <p class="craftsmanship__card-caption">
              ミキハウスは世界16の国と地域で店舗を展開しており、各国の品質・安全基準をクリアするため、日本で未規制の化学物質も使用しないなど独自基準を設け、どこでも安心して使えるグローバル品質を実現しています。
            </p>
          </div>
        </div>
      </div>
  ...
  <section class="global-expansion" id="global-expansion">
    <div class="global-expansion__inner sub-inner">
      ...
      <time class="global-expansion__date" datetime="2025-08">2025年8月現在</time>
      ...
      <div class="global-expansion__content-list">
        <div class="global-expansion__content">
          ...
          <p class="global-expansion__text">
            ミキハウスの舞台は、日本を超え、世界に広がっています。
            ロンドンのハロッズ店、パリの路面店、北京のSKP店、シンガポールのマリーナベイサンズ店、そして2025年春にオープンしたニューヨークのザ・プラザホテル店まで。
          </p>
        </div>
      ...
      <ul class="data-view__list js-data-view-count-up">
        ...
        <li class="data-view__item data-view__item--01">
          ...
          <div class="data-view__body">
            ...
            <p class="data-view__value">世界<span class="data-view__num" data-count-to="16">0</span>の国と地域</p>
        ...
        <li class="data-view__item data-view__item--02">
          ...
          <p class="data-view__label">海外店舗数</p>
          <p class="data-view__value"><span class="data-view__num" data-count-to="108">0</span>店舗</p>
          <time class="data-view__date" datetime="2025-08">2025年8月時点</time>
        </li>
        ...
        <li class="data-view__item data-view__item--03">
          ...
          <p class="data-view__value">
            <span class="data-view__num" data-count-to="18269">0</span>百万円
          </p>
        ...
        <li class="data-view__item data-view__item--04">
          ...
          <p class="data-view__value"><span class="data-view__num" data-count-to="514">0</span>名</p>
          <time class="data-view__date" datetime="2025-06">2025年3月時点</time>
        </li>
      ...
      <ul class="business__list">
        ...
        <li class="business__item business__item--01">
          ...
          <p class="business__text">
            「子どものことを第一に考えた」ものづくりに取り組み、そのクオリティとデザインは世界中から定評をいただいています。国内直営店約90店舗をはじめ、パリ、ニューヨーク、ロンドン、シンガポール、上海、台北、バンコク、ホーチミン、ソウル、メルボルンなど世界各都市に108店舗（2025年8月現在）を展開。また国内外でオンラインショップを運営しています
          </p>
        </li>
        ...
        <li class="business__item">
          ...
          <p class="business__text">
            楽習（楽しい学び）を通して親子の今を未来につなげる幼児教室「ミキハウスキッズパル」、１歳からの本格的で楽しい幼児専門の英会話教室「ミキハウス
            英会話くらぶ」、志望校合格という親子の夢を全力で応援する「ミキハウスキッズパル 小学校受験コース」を全国の百貨店内で展開しています。
          </p>
        </li>
        ...
        <li class="business__item">
          ...
          <p class="business__text">
            子育て応援ポータルサイトとして日本最大級の「ハッピーノート.com」を運営。子育ての不安や悩みに専門家や先輩ママがアドバイスをしています。また、年4回全国の直営店や提携医療機関で配布されているフリーマガジン「Happy-Note」では、子どもを取り巻く健康的で楽しい安心・安全なくらしの提案や、家族の思い出づくりのサポートをしています。
          </p>
        </li>
  ...
  <section class="brand" id="brand">
    <div class="brand__inner sub-inner">
      ...
      <p class="brand__lead">
        ミキハウスの原点にあるもの－それは「子どもたちへの愛情」です。創業以来、ベビー・子供服アパレルの分野で、子どものことを第一に考えたものづくりに取り組んできました。「子どもと家族の毎日を笑顔でいっぱいに」というビジョンのもと、「子供服ブランド」という概念を覆す分野へと活動の領域を広げていきます。世界中のベビーと子どもとご家族のために、できることをひとつひとつ取り組みカタチにしていきたい･･･ミキハウスの事業は、日本から世界へとさらに広がっていきます。
      </p>
      ...
      <ul class="brand__list">
        ...
        <li class="brand__item brand__item--02 js-fade-in --delay-2">
          <a href="https://www.mikihouse.co.jp/pages/brand/mikihouse" class="brand__link" target="_blank"
            ...
            <div class="brand__img-wrap">
              <picture>
                <source srcset="<?php echo IMAGEPATH; ?>/about/brand-img03-sp.webp" media="(max-width: 767px)"
                  type="image/webp" width="319" height="180">
                <img src="<?php echo IMAGEPATH; ?>/about/brand-img03.webp" class="brand__img" alt="カラフルな衣装を着た子どもたち"
                  width="329.33" height="270" loading="lazy">
              </picture>
            </div>
            <div class="brand__logo-wrap">
        ...
        <li class="brand__item brand__item--03 js-fade-in --delay-4">
          <a href="https://www.mikihouse.co.jp/pages/brand/mikihouse_formal" class="brand__link" target="_blank"
            ...
            <div class="brand__img-wrap">
              <picture>
                <source srcset="<?php echo IMAGEPATH; ?>/about/brand-img04-sp.webp" media="(max-width: 767px)"
                  type="image/webp" width="319" height="180">
                <img src="<?php echo IMAGEPATH; ?>/about/brand-img04.webp" class="brand__img" alt="フォーマルなスーツとワンピースを着た子どもたち"
                  width="329.33" height="270" loading="lazy">
              </picture>
            </div>
            <div class="brand__logo-wrap">
        ...
        <li class="brand__item brand__item--04 js-fade-in">
          <a href="https://www.mikihouse.co.jp/pages/brand/doubleb" class="brand__link" target="_blank"
            ...
            <div class="brand__img-wrap">
              <picture>
                <source srcset="<?php echo IMAGEPATH; ?>/about/brand-img05-sp.webp" media="(max-width: 767px)"
                  type="image/webp" width="319" height="180">
                <img src="<?php echo IMAGEPATH; ?>/about/brand-img05.webp" class="brand__img" alt="赤い乗り物に乗って遊ぶ子どもたち"
                  width="329.33" height="270" loading="lazy">
              </picture>
            </div>
            <div class="brand__logo-wrap">
        ...
        <li class="brand__item brand__item--05 js-fade-in --delay-2">
          <a href="https://www.mikihouse.co.jp/pages/brand/chiecosaku" class="brand__link" target="_blank"
            ...
            <div class="brand__img-wrap">
              <picture>
                <source srcset="<?php echo IMAGEPATH; ?>/about/brand-img06-sp.webp" media="(max-width: 767px)"
                  type="image/webp" width="319" height="180">
                <img src="<?php echo IMAGEPATH; ?>/about/brand-img06.webp" class="brand__img" alt="ピンク色のドレスを着た子どもたち"
                  width="329.33" height="270" loading="lazy">
              </picture>
            </div>
            <div class="brand__logo-wrap">
        ...
        <li class="brand__item brand__item--06 js-fade-in --delay-4">
          <a href="https://www.mikihouse.co.jp/pages/brand/hotbiscuits" class="brand__link" target="_blank"
            ...
            <div class="brand__img-wrap">
              <picture>
                <source srcset="<?php echo IMAGEPATH; ?>/about/brand-img07-sp.webp" media="(max-width: 767px)"
                  type="image/webp" width="319" height="180">
                <img src="<?php echo IMAGEPATH; ?>/about/brand-img07.webp" class="brand__img" alt="明るい色の洋服を着て笑う子どもたち"
                  width="329.33" height="270" loading="lazy">
              </picture>
            </div>
            <div class="brand__logo-wrap">
    ...
    <div class="company__inner sub-inner">
      ...
      <dl class="company__list">
        ...
        <div class="company__item">
          ...
          <dd class="company__desc">514&nbsp;名<time class="company__date" datetime="2025-03">（2025年3月時点）</time></dd>
        </div>
