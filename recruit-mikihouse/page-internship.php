        ...
        <ul class="internship__list">
          ...
          ?>
            <li class="internship__item">
              <?php if ( $url ) : ?>
                <a href="<?php echo esc_url($url); ?>" class="internship__link">
              <?php else: ?>
          ...
          <ul class="internship__other-list">
            ...
            ?>
              <li class="internship__other-item">
                <?php if ( $url ) : ?>
                  <a href="<?php echo esc_url($url); ?>" class="internship__other-link">
                <?php else: ?>
              ...
              <ul class="internship__year-list">
                ...
                ?>
                  <li class="internship__year-item">
                    <?php if ( $url ) : ?>
                      <a href="<?php echo esc_url($url); ?>" class="internship__year-link">
                    <?php else: ?>
